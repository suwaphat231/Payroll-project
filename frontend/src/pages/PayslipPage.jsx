    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 md:p-8">
      <div className="mx-auto max-w-4xl space-y-4">
        ...
        <div className="print:hidden flex items-center justify-between">
          <h1 className="text-xl font-bold text-white">สลิปเงินเดือน (Payslip)</h1>
          ...
          <div className="mb-6 grid grid-cols-1 gap-4 rounded-2xl bg-slate-700/50 p-4 md:grid-cols-3 print:bg-slate-50">
            ...
            {data?.employee?.bank && (
              <div className="md:col-span-3">
                ...
                <div className="font-medium text-white print:text-black">{data.employee.bank.name} • {data.employee.bank.account}</div>
              </div>
            )}
          </div>
